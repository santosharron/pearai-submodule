...
function HelpPage() {
  ...
  const [session, setSession] = useState(false); // this state specifically serves to manage "Login to Dropstone" text conditionally on auth status
    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-center w-full">
        <ButtonContainer>
          ...
          >
            {session ? "Relogin to Dropstone" : "Login to Dropstone"}
          </StyledButton>
          <StyledLink
