...
export const models: { [key: string]: ModelPackage } = {
  dropstone_search: {
    ...
    description:
      "An AI-powered search assistant that provides up-to-date information from the web and documentation.",
    params: {
  ...
  dropstone_memory: {
    ...
    description:
      "An AI-powered memory manager that helps you store, retrieve, and manage important information about your coding projects.",
    params: {
      model: "dropstone-memory",
      contextLength: 300_000,
      title: "Dropstone Memory",
      systemMessage:
        "You are an expert memory manager. You help users store, retrieve, and manage important information about their coding projects and preferences.",
    },
    providerOptions: ["custom"],
    icon: "dropstone.png",
    isOpenSource: false,
