...
export type ToIdeFromWebviewProtocol = ToIdeFromWebviewOrCoreProtocol & {
  ...
  saveDropstoneAuth: [{ token: string; userInfo: any }, { success: boolean; error?: string }];
  getCreatorFeedbackMessages: [undefined, any[]];
...
export type ToWebviewFromIdeProtocol = ToWebviewFromIdeOrCoreProtocol & {
  ...
  dropstoneAuthExpired: [{ error: string }, void];
  dropstoneAuthUpdated: [{ token: string; updatedCount: number }, void];
};
